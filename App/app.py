...
# -----------------------------------------------------------------------------------------------------------------------------------
        ...
        movies = pickle.load(open('D:\ML\end2end-nlp-project\App\models\\movie_list.pkl', 'rb'))
        similarity = pickle.load(open('D:\ML\end2end-nlp-project\App\models\\similarity.pkl', 'rb'))
